...
export const HERO = {
  ...
  titlePlain: "역할이 바뀌는 순간마다,\n다른 리더십이 필요합니다",
  sub: "신입부터 최고경영진까지, 성장 단계마다 필요한 리더십을 진단에서 조직문화 정착까지 하나의 체계로 설계합니다.",
...
export const JOURNEY = {
  ...
  lead: "신입부터 최고경영진까지 6단계 성장 로드맵. 각 단계에 필요한 핵심역량을 한눈에 봅니다.",
  steps: [
    {
      no: 1,
      stage: "신입",
...
export const TRACKS_INTRO = {
  ...
  lead: "KG에듀원 고유의 리더십 역량 체계입니다. 여정의 각 단계는 이 6대 역량으로 구성됩니다.",
};
...
export const WHEEL_TRACKS: WheelTrack[] = [
  {
    ...
    nm: "Self",
    t: "Self Leadership",
    d: "스스로를 이끄는 리더의 출발점입니다. 자기 이해와 회복탄력성을 바탕으로 지속 성장하는 역량입니다.",
  ...
  },
  {
    ...
    nm: "People",
    t: "People Leadership",
    d: "사람을 성장시키는 리더입니다. 코칭과 피드백으로 구성원의 잠재력을 끌어냅니다.",
  ...
  },
  {
    ...
    d: "성과를 만드는 리더입니다. 목표에서 실행까지 조직의 결과를 책임집니다.",
  ...
  },
  {
    ...
    nm: "Change",
    t: "Change Leadership",
    d: "변화를 이끄는 리더입니다. 혁신과 디지털 전환으로 조직을 진화시킵니다.",
  ...
  },
  {
    ...
    nm: "Hyper",
    t: "Hyper Leadership",
    d: "연결하는 리더입니다. 협업과 영향력으로 경계를 넘는 성과를 만듭니다.",
  ...
  },
  {
    ...
    d: "문화를 세우는 리더입니다. 심리적 안전감과 학습문화로 지속가능한 조직을 만듭니다.",
...
export const OFFLINE_INTRO = {
  ...
  lead: (
    <>
      입사·승진·팀장·임원처럼 역할이 바뀌는 시점을 선택하면 맞는 트랙이
      열립니다.
      <br />
